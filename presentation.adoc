...
{
  "defines": [{
    "comment": "The most recent version of the EOS_Achievements_CopyAchievementDefinitionByIndexOptions struct.",
    "expression": "2",
    "name": "EOS_ACHIEVEMENTS_COPYACHIEVEMENTDEFINITIONV2BYINDEX_API_LATEST",
    "parameters": null,
    "source": "eos_achievements_types.h"
  }]
}
--
...
{
  "enums": [{
    "comment": "Enum flags for all possible result values of operations in the SDK.",
...
--
{
  "enums": [{
    ...
    "values": [
      {
        "comment": "Successful result. no further error processing needed",
        "name": "EOS_Success",
        "value": "0"
      }
    ]
...
{
  "structs":  [{
      "comment": "Input parameters for the EOS_Achievements_CopyAchievementDefinitionByIndex function.",
      "fields": [
        {
          "comment": "API Version: Set this to EOS_ACHIEVEMENTS_COPYACHIEVEMENTDEFINITIONV2BYINDEX_API_LATEST.",
          "name": "ApiVersion",
          "recommended_value": "EOS_ACHIEVEMENTS_COPYACHIEVEMENTDEFINITIONV2BYINDEX_API_LATEST",
          "type": "int32_t"
        },
        {
          "comment": "Index of the achievement definition to retrieve from the cache.",
...
--
{
  "functions": [{
    ...
    "methodname_flat": "EOS_Achievements_CopyAchievementDefinitionV2ByIndex",
    "params": [
    {
      "name": "Handle",
      "type": "EOS_HAchievements"
    },
    {
      "name": "Options",
      "type": "const EOS_Achievements_CopyAchievementDefinitionV2ByIndexOptions*"
    },
    {
      "name": "OutDefinition",
      "type": "EOS_Achievements_DefinitionV2 **"
    }
    ],
    "returntype": "EOS_EResult",
    "source": "eos_achievements.h"
    }]
}
--
...
{
  "callback_methods": [{
    "callbackname": "EOS_Connect_OnLoginCallback",
    "comment": "Function prototype definition for callbacks passed to EOS_Connect_Login.\n\n@param Data A EOS_Connect_LoginCallbackInfo containing the output information and result.",
    "params": [
      {
        "name": "Data",
        "type": "const EOS_Connect_LoginCallbackInfo*"
      }
    ],
    "returntype": "void",
    "source": "eos_connect_types.h"
  }]
}
--
